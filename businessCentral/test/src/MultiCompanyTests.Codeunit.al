codeunit 85574 "AZD Multi Company Tests"
{
    Subtype = Test;
    ...
    var
        ADLSESyncCompanies: Record "AZD Sync Companies";
    ...
    var
        ADLSECompaniesTable: Record "AZD Companies Table";
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Multi Company Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Multi Company Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Multi Company Tests");
    end;
}
