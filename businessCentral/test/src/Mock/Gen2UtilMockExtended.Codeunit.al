codeunit 85568 "AZD Gen 2 Util Mock Extended"
{
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"AZD Gen 2 Util", OnBeforeGetBlobContent, '', false, false)]
    local procedure OnBeforeGetBlobContentOnGen2Util(BlobPath: Text; ADLSECredentials: Codeunit "AZD Credentials"; var BlobExists: Boolean; var Content: JsonObject; var IsHandled: Boolean)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"AZD Gen 2 Util", OnBeforeCreateBlockBlob, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"AZD Gen 2 Util", OnBeforeGetBlobContentLength, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"AZD Gen 2 Util", OnBeforeAddBlockToDataBlob, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"AZD Gen 2 Util", OnBeforeCommitAllBlocksOnDataBlob, '', false, false)]
