codeunit 85576 "AZD Setup Validation Tests"
{
    Subtype = Test;
    ...
    begin
        ...
        ADLSESetup.Validate("Storage Type", "AZD Storage Type"::"Open Mirroring");
    ...
    begin
        ...
        LibraryAssert.AreEqual("AZD CDM Format"::Parquet, ADLSESetup.DataFormat, 'Default data format should be Parquet');
    end;
    ...
    var
        ADLSESetup: Record "AZD Setup";
        StorageTypeResult: Enum "AZD Storage Type";
    begin
        ...
        LibraryAssert.AreEqual("AZD Storage Type"::"Azure Data Lake", StorageTypeResult, 'Should return Azure Data Lake');
    end;
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Setup Validation Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Setup Validation Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Setup Validation Tests");
    end;
}
