codeunit 85569 "AZD CDM Util Tests"
{
    Subtype = Test;
    ...
    begin
        ...
        ManifestContent := ADLSECDMUtil.UpdateDefaultManifestContent(EmptyJsonObject, Database::"Reason Code", 'data', "AZD CDM Format"::Parquet);
    ...
    begin
        ...
        ManifestContent := ADLSECDMUtil.UpdateDefaultManifestContent(EmptyJsonObject, Database::"Reason Code", 'deltas', "AZD CDM Format"::Csv);
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD CDM Util Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD CDM Util Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD CDM Util Tests");
    end;
}
