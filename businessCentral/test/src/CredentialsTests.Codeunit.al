codeunit 85573 "AZD Credentials Tests"
{
    Subtype = Test;
    ...
    var
        ADLSECredentials: Codeunit "AZD Credentials";
        StorageType: Enum "AZD Storage Type";
    begin
    ...
    var
        ADLSECredentials1: Codeunit "AZD Credentials";
        ADLSECredentials2: Codeunit "AZD Credentials";
        TestTenantId: Text;
        TestClientId: Text;
        TestSecret: Text;
    begin
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Credentials Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Credentials Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Credentials Tests");
    end;
}
