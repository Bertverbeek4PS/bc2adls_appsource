codeunit 85572 "AZD Communication Tests"
{
    Subtype = Test;
    ...
    begin
        ...
        ADLSECommunication.CheckEntity("AZD CDM Format"::Parquet, EntityJsonNeedsUpdate, ManifestJsonsNeedsUpdate, true);
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Communication Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Communication Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Communication Tests");
    end;
}
