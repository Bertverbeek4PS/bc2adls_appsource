codeunit 85575 "AZD Error Handling Tests"
{
    Subtype = Test;
    ...
    var
        ADLSEGen2UtilMockExtended: Codeunit "AZD Gen 2 Util Mock Extended";
        ADLSEGen2Util: Codeunit "AZD Gen 2 Util";
    ...
    begin
        // Captures the "skipped primary key fields" message raised by AZD Table.Add.
    end;
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Error Handling Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Error Handling Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Error Handling Tests");
    end;
