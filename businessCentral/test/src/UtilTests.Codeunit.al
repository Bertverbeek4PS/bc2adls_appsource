codeunit 85570 "AZD Util Tests"
{
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"AZD Util Tests");

        if IsInitialized then
            exit;

        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"AZD Util Tests");

        IsInitialized := true;
        Commit();

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"AZD Util Tests");
    end;
}
