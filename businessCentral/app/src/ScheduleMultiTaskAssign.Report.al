...
report 11344437 "AZDScheduleMultiTaskAssign"
{
    ...
    dataset
    {
        dataitem(AZDTable; "AZD Table")
        {
            RequestFilterFields = ExportCategory;
            trigger OnPreDataItem()
            var
                JobQueueEntry: Record "Job Queue Entry";
                AZDMultiCompanyExport: Codeunit "AZD Multi Company Export";
            begin
                AZDMultiCompanyExport.Run(JobQueueEntry);
            end;
        }
    }
    requestpage
    ...
    var
        Description: Text[30];
        JobCategoryCodeTxt: Label 'AZD', Locked = true;
    ...
    begin
        ...
        JobQueueEntry.Validate("Object ID to Run", Report::AZDScheduleMultiTaskAssign);
