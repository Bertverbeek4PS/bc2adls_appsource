...
codeunit 11344438 "AZD CDM Util" // Refer Common Data Model https://docs.microsoft.com/en-us/common-data-model/sdk/overview
{
    Access = Internal;
    ...
    procedure UpdateDefaultManifestContent(ExistingContent: JsonObject; TableID: Integer; Folder: Text; ADLSECdmFormat: Enum "AZD CDM Format") Content: JsonObject
    var
        ADLSEUtil: Codeunit "AZD Util";
        Entities: JsonArray;
