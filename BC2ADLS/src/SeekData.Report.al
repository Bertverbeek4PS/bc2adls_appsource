...
report 11344440 "AZD Seek Data"
{
    ...
    internal procedure RecordsExist(var ADLSEDeletedRecord: Record "AZD Deleted Record") Result: Boolean
    begin
    ...
    internal procedure FindRecords(var ADLSEDeletedRecord: Record "AZD Deleted Record") Result: Boolean
    begin
        CurrRecordRef.GetTable(ADLSEDeletedRecord);
