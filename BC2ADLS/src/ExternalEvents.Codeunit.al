...
codeunit 11344444 "AZD External Events"
{
    SingleInstance = true;

    var
        ADLSEExternalEventsHelper: Codeunit "AZD External Events Helper";
        StorageType, Instance, Resource : Text[250];

    internal procedure OnTableExportRunEnded(RunId: Integer; Started: DateTime; Ended: DateTime; TableId: Integer; State: Enum "AZD Run State")
    var
...
#pragma warning restore AL0432
    ...
    internal procedure OnEnableFieldChanged(ADLSEField: Record "AZD Field")
    var
    ...
    begin
        ...
        WebClientUrl := CopyStr(GetUrl(ClientType::Web, CompanyName(), ObjectType::Page, Page::"AZD Setup", ADLSESetup), 1, MaxStrLen(WebClientUrl));
    ...
    internal procedure OnEnableTableChanged(ADLSEtable: Record "AZD Table")
    var
        ADLSESetup: Record "AZD Setup";
        Url: Text[250];
        WebClientUrl: Text[250];
    ...
    internal procedure OnAddTable(ADLSETable: Record "AZD Table")
    var
        ADLSESetup: Record "AZD Setup";
        Url: Text[250];
        WebClientUrl: Text[250];
    ...
    internal procedure OnDeleteTable(ADLSETable: Record "AZD Table")
    var
        ADLSESetup: Record "AZD Setup";
        Url: Text[250];
        WebClientUrl: Text[250];
    ...
    internal procedure OnExportSchema(ADLSESetup: Record "AZD Setup")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
    ...
    internal procedure OnClearSchemaExportedOn(ADLSESetup: Record "AZD Setup")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
        ADLSEFieldApiUrlTok: Label 'bc2adlsTeamMicrosoft/bc2adls/v1.0/companies(%1)/adlseSetup(%2)', Locked = true;
    ...
    internal procedure OnExport(ADLSESetup: Record "AZD Setup")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
        ADLSEFieldApiUrlTok: Label 'bc2adlsTeamMicrosoft/bc2adls/v1.0/companies(%1)/adlseSetup(%2)', Locked = true;
    ...
    internal procedure OnExportFinished(ADLSESetup: Record "AZD Setup"; ADLSETable: Record "AZD Table")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
        ADLSEFieldApiUrlTok: Label 'bc2adlsTeamMicrosoft/bc2adls/v1.0/companies(%1)/adlseTables(%2)', Locked = true;
    ...
    internal procedure OnAllExportIsFinished(ADLSESetup: Record "AZD Setup")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
        ADLSEFieldApiUrlTok: Label 'bc2adlsTeamMicrosoft/bc2adls/v1.0/companies(%1)/adlseSetup(%2)', Locked = true;
    ...
    internal procedure OnRefreshOptions(ADLSESetup: Record "AZD Setup")
    var
        Url: Text[250];
        WebClientUrl: Text[250];
        ADLSEFieldApiUrlTok: Label 'bc2adlsTeamMicrosoft/bc2adls/v1.0/companies(%1)/adlseSetup(%2)', Locked = true;
    ...
    local procedure ExportEntityEnded(RunId: Integer; Started: DateTime; Ended: DateTime; State: Enum "AZD Run State"; StorageType: Text[250]; Instance: Text[250]; Resource: Text[250]; Entity: Text[250])
    begin
    end;
    ...
    local procedure TableExportRunEnded(RunId: Integer; State: Enum "AZD Run State"; Container: Text[250]; EntityName: Text[250])
    begin
    end;
    ...
    local procedure MyBusinessOnExportSchema(SystemId: Guid; "Storage Type": Enum "AZD Storage Type"; Url: Text[250]; WebClientUrl: Text[250])
    begin
    end;
    ...
    local procedure MyBusinessOnClearSchemaExportedOn(SystemId: Guid; "Storage Type": Enum "AZD Storage Type"; Url: Text[250]; WebClientUrl: Text[250])
    begin
    end;

    [ExternalBusinessEvent('OnExport', 'Export data', 'When the data is exported', EventCategory::ADLSE)]
    local procedure MyBusinessOnExport(SystemId: Guid; "Storage Type": Enum "AZD Storage Type"; Url: Text[250]; WebClientUrl: Text[250])
    begin
    end;
    ...
    local procedure MyBusinessOnAllExportIsFinished(SystemId: Guid; "Storage Type": Enum "AZD Storage Type"; Url: Text[250]; WebClientUrl: Text[250])
    begin
    end;

    [ExternalBusinessEvent('OnRefreshOptions', 'Refresh Options', 'When the options are refreshed', EventCategory::ADLSE)]
    local procedure MyBusinessOnRefreshOptions(SystemId: Guid; "Storage Type": Enum "AZD Storage Type"; Url: Text[250]; WebClientUrl: Text[250])
    begin
    end;

    [EventSubscriber(ObjectType::Table, Database::"AZD Table", OnAfterResetSelected, '', true, true)]
